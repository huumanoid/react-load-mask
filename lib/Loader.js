...
var Loader = function (_React$Component) {
  ...
  _createClass(Loader, [{
    ...
    value: function render() {
      ...
      var renderProps = this.prepareProps(props);

      return _react2.default.createElement(
        'div',
        _extends({}, renderProps, { style: style, className: className }),
    ...
    value: function prepareProps(props) {
      var style = props.style,
          ...
          theme = props.theme,
          size = props.size,
          rest = _objectWithoutProperties(props, ['style', 'className', 'theme', 'size']);

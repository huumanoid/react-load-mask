...
var LoadMask = function (_React$Component) {
  ...
  _createClass(LoadMask, [{
    ...
    value: function render() {
      ...
      var divRenderProps = this.prepareDivProps(props);

      return _react2.default.createElement(
        'div',
        _extends({}, divRenderProps, { className: className }),
        _react2.default.createElement(_Loader2.default, { size: props.size, theme: props.theme })
      );
    }
  }, {
    key: 'prepareDivProps',
    value: function prepareDivProps(props) {
      var visible = props.visible,
          theme = props.theme,
          size = props.size,
          className = props.className,
          rest = _objectWithoutProperties(props, ['visible', 'theme', 'size', 'className']);
